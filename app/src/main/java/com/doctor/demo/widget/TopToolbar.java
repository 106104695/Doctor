package com.doctor.demo.widget;
        ...
        public TopToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            if(attrs !=null) {
                final TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs,
                        R.styleable.TopToolBar, defStyleAttr, 0);


                final Drawable rightIcon = a.getDrawable(R.styleable.TopToolBar_rightButtonIcon);
                if (rightIcon != null) {
                ...
                boolean isShowSearchView = a.getBoolean(R.styleable.TopToolBar_isShowSearchView,false);
                ...
                CharSequence rightButtonText = a.getText(R.styleable.TopToolBar_rightButtonText);
